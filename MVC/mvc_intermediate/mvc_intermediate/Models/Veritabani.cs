...
namespace mvc_intermediate.Models
{
    ...
    //Bilgiler bellekte saklanır.Uygulama çalıştığından sonlanana kadar bu bilgilere
    //ulaşabiliriz.
    public static class Veritabani
    {
        ...
        static Veritabani()
        {
            _liste = new List<Urun>()
            {
                   ...
                   new Urun(){ UrunId=2,UrunAdi="Samsung S7", Aciklama="idare eder", Fiyat=1000, Satistami=true,Resim="2.jpg"},
                   new Urun(){ UrunId=3,UrunAdi="Samsung S8", Aciklama="idare eder", Fiyat=2000, Satistami=true,Resim="3.jpg"},
                   new Urun(){ UrunId=4,UrunAdi="IPhone 6", Aciklama="idare eder", Fiyat=3000, Satistami=true,Resim="4.jpg"},
                   new Urun(){ UrunId=5,UrunAdi="IPhone 7S", Aciklama="idare eder", Fiyat=3000, Satistami=true,Resim="1.jpg"},
                   new Urun(){ UrunId=6,UrunAdi="IPhone 7S", Aciklama="idare eder", Fiyat=3000, Satistami=true,Resim="2.jpg"},
                   new Urun(){ UrunId=7,UrunAdi="IPhone 7S", Aciklama="idare eder", Fiyat=3000, Satistami=false,Resim="3.jpg"},
                   new Urun(){ UrunId=8,UrunAdi="IPhone 7S", Aciklama="idare eder", Fiyat=3000, Satistami=true,Resim="4.jpg"},
                   new Urun(){ UrunId=9,UrunAdi="IPhone 7S", Aciklama="idare eder", Fiyat=3000, Satistami=false,Resim="1.jpg"}
             };
        }
